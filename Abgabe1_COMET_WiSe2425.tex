...
\begin{itemize}
    ...
    \item select max(average\_temperature) from FVerleih where \grqq group\grqq=70 and average\_temperature between -1 and 99;
\end{itemize} 
...
\begin{itemize}
    ...
    \item .schema
    \item .mode columns
    \item select max(average\_temperature) from bike where \grqq group\grqq=70 and \\average\_temperature between 1 and 99;
\end{itemize}
